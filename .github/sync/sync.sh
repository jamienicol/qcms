...
# FirefoxGraphics GitHub organisation's standalone fork [2]. This script runs as
# part of a GitHub Action in this repository triggered on regular intervals.
# This script has been copied from Servo's webrender fork. [3]
#
...
if ! [ -e upstream ]; then
    git clone --bare --single-branch --progress https://github.com/jamienicol/gecko-dev.git upstream
fi
